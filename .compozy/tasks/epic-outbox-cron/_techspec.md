# TechSpec — Cron contínuo da outbox

## Escopo técnico
Implementar apenas o módulo `epic-outbox-cron` conforme histórias deste diretório.
...
## Perguntas abertas
Ver `.compozy/WORKFLOWS.md` → tabela do épico `epic-outbox-cron`.
